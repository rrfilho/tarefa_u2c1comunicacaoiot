...
static char* _first_line_message = "x.x.x.x";
...
static bool display_update() {
    ...
    draw_string(_first_line_message, 10, 28);
    draw_string(_second_line_message, 10, 41);
    send_data();
    return true;
}
...
void display_set_first_line_message(char* message) {
    _first_line_message = message;
}

void display_set_second_line_message(char* message) {
